<?php
/* Smarty version 5.5.1, created on 2026-01-08 15:55:03
  from 'file:C:\laragon\www\magnumucsm\views\index\index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_696019a73ced23_32538821',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8b4bf2c5d6fd76da50e52c78f15579b21adac984' => 
    array (
      0 => 'C:\\laragon\\www\\magnumucsm\\views\\index\\index.tpl',
      1 => 1767905701,
      2 => 'file',
    ),
  ),
...
function content_696019a73ced23_32538821 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\magnumucsm\\views\\index';
?><!-- Hero Section Start -->
			...
			<div class="col-lg-6">
				<div class="hero-content">
					...
					<div class="hero-button">
						<a href="index.php" class="theme-btn hover-white wow fadeInUp" data-wow-delay=".4s">Get Started
							Now <i class="far fa-arrow-right"></i></a>
						<a href="service.php" class="btn-link wow fadeInUp" data-wow-delay=".6s">View Services <i
...
<section class="service-section fix pt-80 pb-80 section-bg">
	<div class="container">
		<h4 class="mb-5 text-white text-center wow fadeInUp" data-wow-delay=".3s">Preparing For Your Business Success
			With IT Solution</h4>
		<div class="row g-4">
				...
				<div class="col-lg-6">
					<div class="about-content">
						...
						<p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
							Sed ut perspiciatis unde omnis iste natus error sit volupta temes accusantium doloremque
		...
		<div class="marquee-inner to-left">
			<ul class="marqee-list d-flex">
				<li class="marquee-item">
					<span class="text-slider">IT</span><span class="text-slider">Consulting </span><span
						class="text-slider style-border"></span>
					<span class="text-slider">Co</span><span class="text-slider">Machine </span><span
						class="text-slider style-border"></span><span class="text-slider">IT</span><span
						class="text-slider">Learning </span><span class="text-slider style-border"></span><span
						class="text-slider">Web </span><span class="text-slider">Development</span>
					<span class="text-slider">IT</span><span class="text-slider">Consulting </span><span
						class="text-slider style-border"></span>
					<span class="text-slider">Co</span><span class="text-slider">Machine </span><span
						class="text-slider style-border"></span><span class="text-slider">IT</span><span
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			<div class="col-lg-6">
				...
				<p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
					Sed ut perspiciatis unde omnis iste natus error sit volupta temes <br> accusantium doloremque
					laudantium, totam rem
				</p>
			</div>
...
<?php echo '<?php'; ?>
 include './partials/pricing.php'<?php echo '?>'; ?>
		...
		<div class="row">
			<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
				<div class="news-box-items">
					<div class="news-content">
						...
						<h4><a href="news-details.php">Revealing Images With Animations Gradients, Blend Modes Cool</a>
						</h4>
			...
			<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
				<div class="news-box-items">
					<div class="news-content">
						<p>November 25, 2024</p>
						<h4><a href="news-details.php">List of 5 ways Generating Real Time Audio Sentiment Analysis</a>
						</h4>
						<a class="link-btn" href="news-details.php">Read More<i class="far fa-arrow-right"></i></a>
					</div>
