<?php
/* Smarty version 5.5.1, created on 2026-04-30 15:05:07
  from 'file:views/fernandayromme/components/galery.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_69f3b5f37fb808_00590719',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3b3b6da7ed68166a871a61ba1419619d9b9cf0fa' => 
    array (
      0 => 'views/fernandayromme/components/galery.tpl',
      1 => 1777579505,
      2 => 'file',
    ),
  ),
...
function content_69f3b5f37fb808_00590719 (\Smarty\Template $_smarty_tpl) {
...
views/fernandayromme/imgs/preboda-1.webp" alt="Imagen 1">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/fernandayromme/imgs/preboda-2.webp" alt="Imagen 2">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/fernandayromme/imgs/preboda-3.webp" alt="Imagen 3">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/fernandayromme/imgs/preboda-5.webp" alt="Imagen 3">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/fernandayromme/imgs/preboda-4.webp" alt="Imagen 3">
            </div>
        </div>
    </div>
</section>
