...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_6a65333b5cf2e1_81129337',
...
function content_6a65333b5cf2e1_81129337 (\Smarty\Template $_smarty_tpl) {
...
views/julissayruben/imgs/icono_copas.webp" alt="">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_anillos.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_cocina.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_musica.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_ramo.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_botella.webp" alt="">
                    </span>
                    <div class="tl-text">
        ...
        <div class="dc-dress" data-aos="fade-up">
            ...
            <div class="dc-attire" aria-hidden="true">
                <span class="dc-attire-icon">
                    <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_varon.webp" alt="">
                </span>
                <span class="dc-attire-icon">
                    <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/julissayruben/imgs/icono_dama.webp" alt="">
                </span>
            </div>
