<?php
/* Smarty version 5.5.1, created on 2026-05-16 08:11:39
  from 'file:views/paolaymiguel/components/galery.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_6a086d0b2515b3_73430204',
...
function content_6a086d0b2515b3_73430204 (\Smarty\Template $_smarty_tpl) {
...
views/paolaymiguel/imgs/preboda.webp" alt="Imagen 2">
            ...
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/paolaymiguel/imgs/preboda-2.webp" alt="Imagen 2">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/paolaymiguel/imgs/preboda-3.webp" alt="Imagen 3">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/paolaymiguel/imgs/preboda-4.webp" alt="Imagen 4">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/paolaymiguel/imgs/preboda-5.webp" alt="Imagen 5">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/paolaymiguel/imgs/preboda-6.webp" alt="Imagen 6">
            </div>
            <div class="item"><img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
