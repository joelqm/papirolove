...
/* Smarty version 5.5.1, created on 2026-08-01 09:22:25
  from 'file:views/flaviayanibal/components/dresscode.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_6a6e012144f455_65425573',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'abd1b94afec582c65f721a4173391242fd2a5d7d' => 
    array (
      0 => 'views/flaviayanibal/components/dresscode.tpl',
      1 => 1785594044,
      2 => 'file',
    ),
  ),
...
function content_6a6e012144f455_65425573 (\Smarty\Template $_smarty_tpl) {
...
views/flaviayanibal/imgs/imagen_historia_flores_inferior_der.webp"
         alt=""
         aria-hidden="true">
...
views/flaviayanibal/imgs/icono_iglesia.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_copas.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_anillos.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_cocina.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_musica.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_ramo.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_botella.webp" alt="">
                    </span>
                    <div class="tl-text">
        ...
        <div class="dc-dress" data-aos="fade-up">
            ...
            <div class="dc-attire" aria-hidden="true">
                <span class="dc-attire-icon">
                    <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_varon.webp" alt="">
                </span>
                <span class="dc-attire-icon">
                    <img src="<?php echo $_smarty_tpl->getValue('_layoutParams')['root'];?>
views/flaviayanibal/imgs/icono_dama.webp" alt="">
                </span>
            </div>
