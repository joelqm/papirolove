...
class lizethyerickController extends Controller
{

	private $_lizethyerick;
	private $_dt;
	private $_key;
	...
	public function guardarMensaje()
	{
		...
		echo json_encode($registro = $this->_lizethyerick->guardarmensaje(
	...
	public function guardarmensajeMonto()
	{
		...
		echo json_encode($registro = $this->_lizethyerick->guardarmensajeMonto(
			$messageId,
	...
	public function g_ao()
	{
		...
		echo json_encode($this->_lizethyerick->g_ao($this->getTexto("ao")));
	...
	public function obsequio($codigo)
	{
		...
		$ps_k = $this->_lizethyerick->keysEmp($this->_key);
		$mensaje = $this->_lizethyerick->buscarMensaje($codigo);
	...
	public function estado($codigo)
	{
		...
		if ($formAnswer['kr-answer']['orderStatus'] == 'PAID') {
			...
			$this->_lizethyerick->cambiarMensajeEstado($codigo, $uuid, $hash, $formAnswer['kr-answer']['orderStatus']);
	...
	{
		echo json_encode($this->_lizethyerick->enviarCorreo($codigo));
	}
