...
<head>
	...
	<title>{$titulo|default:"papirolove.pe"}</title>
	...
	<meta property="og:url" content="https://papirolove.pe/danielayluis" />
		...
		<header id="header">
			<div class="nav-section light no-menu">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<a href="{$_layoutParams.root}" class="nav-logo"><img
									src="{$_layoutParams.ruta}images/logo-white-2023.png" alt="papirolove.pe" /></a>
