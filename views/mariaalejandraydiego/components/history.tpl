    ...
    <div class="container-history" id="new-history">
        ...
        <div class="section">
            ...
            <div class="audio-container-history" style="margin: 0px auto;">
              <audio id="myAudio" src="{$_layoutParams.root}views/mariaalejandraydiego/sound/song.mp3" preload="auto"></audio>
            </div>
        ...
        <!-- <div class="rm-container">
            <img class="history-logo" src="{$_layoutParams.root}views/mariaalejandraydiego/imgs/logo.webp" alt="logo">
        </div> -->
        ...
        <div class="history-images" data-aos="fade-up">
          ...
          <div class="photo-stack">
              <img src="{$_layoutParams.root}views/mariaalejandraydiego/imgs/preboda-2.webp" alt="Foto de la pareja" class="circular-image">
              <img src="{$_layoutParams.root}views/mariaalejandraydiego/imgs/preboda-1.webp" alt="Pareja en las vías del tren" class="rectangular-image">
          </div>
