...
.decor-corner-top-left {
    ...
    width: 300px;
    height: 400px;
    background-image: url('{$_layoutParams.root}views/mariaalejandraydiego/imgs/flores-arriba-izq.png'); 
...
.decor-corner-bottom-right {
    ...
    width: 350px;
    height: 350px;
    background-image: url('{$_layoutParams.root}views/mariaalejandraydiego/imgs/flores-abajo-der.png'); /* Aquí usé la imagen que ya tenías */
    background-size: contain;
                ...
                <div class="container" style="max-width: 700px; margin: 0 auto;">
                    ...
                    <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                        ...
                        <div class="col" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                            <img src="{$_layoutParams.root}views/mariaalejandraydiego/imgs/dresscode-1.png" alt="Damas" class="dresscode-img" style="width: 180px; margin-bottom: 15px;">
                            <span style="color: #ba8d72; font-size: 1.1rem; line-height: 1.3;">Reserva las tonalidades claras y amarillas para la novia</span>
                        </div>
                
                        <!-- Columna 2: Varones -->
                        <div class="col" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                            <img src="{$_layoutParams.root}views/mariaalejandraydiego/imgs/dresscode-2.png" alt="Varones" class="dresscode-img" style="width: 160px; margin-bottom: 15px;">
