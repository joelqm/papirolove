<style>
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/mariaalejandraydiego/fonts/Baskervville-Regular.ttf");
        font-display: swap;
    }
    @font-face {
        font-family: 'CalliforniaSignature';
        src: url("{$_layoutParams.root}views/mariaalejandraydiego/fonts/CalliforniaSignature.ttf");
        font-display: swap;
    }

    @font-face {
        font-family: 'newyork_personal';
        src: url("{$_layoutParams.root}views/mariaalejandraydiego/fonts/newyork_personal_use.otf") format("opentype");
        font-display: swap;
    }
