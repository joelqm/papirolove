...
<script src="https://api.micuentaweb.pe/static/js/krypton-client/V4.0/stable/kr-payment-form.min.js"
    kr-public-key="{$pk}" kr-post-url-success="{$_layoutParams.root}flaviayanibal/estado/{$codigo}">
    </script>
{block name="styles"}
<style>
    /* General Styles */
    ...
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/flaviayanibal/fonts/AngellicaSignature.otf") format("opentype");
        font-display: swap;
    }
