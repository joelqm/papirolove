<style>
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/flaviayanibal/fonts/Baskervville-Regular.ttf");
        font-display: swap;
    }
    @font-face {
        font-family: 'CalliforniaSignature';
        src: url("{$_layoutParams.root}views/flaviayanibal/fonts/CalliforniaSignature.ttf");
        font-display: swap;
    }

    @font-face {
        font-family: 'newyork';
        src: url("{$_layoutParams.root}views/flaviayanibal/fonts/newyork.otf") format("opentype");
        font-display: swap;
    }
...
<div class="coming-soon-page">
    <div class="coming-soon-card">
        ...
        <img class="coming-soon-logo"
             src="{$_layoutParams.root}views/flaviayanibal/imgs/logo.png"
             alt="Flavia y Aníbal">
