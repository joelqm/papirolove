<section class="history-section" id="new-history">
    ...
    <img class="history-flower history-flower-tl"
         src="{$_layoutParams.root}views/flaviayanibal/imgs/imagen_historia_flores_superior_izq.webp"
         alt=""
         aria-hidden="true">
    ...
    <audio id="myAudio" src="{$_layoutParams.root}views/flaviayanibal/sound/song.mp3" preload="auto"></audio>
    ...
    <div class="container-history">
        ...
        <div class="history-images" data-aos="fade-up">
            <img src="{$_layoutParams.root}views/flaviayanibal/imgs/preboda-5.webp" alt="Foto de la pareja"
                class="circular-image">
            <img src="{$_layoutParams.root}views/flaviayanibal/imgs/preboda-4.webp" alt="Pareja en las vías del tren"
