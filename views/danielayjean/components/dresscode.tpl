<section class="dresscode-container" id="dresscode">
    ...
    <img class="dc-flower dc-flower-br"
         src="{$_layoutParams.root}views/danielayjean/imgs/imagen_historia_flores_inferior_der.webp"
         alt=""
         aria-hidden="true">
    ...
    <div class="dc-grid">
        ...
        <div class="dc-timeline" data-aos="fade-up">
            ...
            <ul class="tl-list">
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_iglesia.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_copas.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_anillos.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_cocina.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_musica.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_ramo.webp" alt="">
                    </span>
                    <div class="tl-text">
                ...
                <li class="tl-item">
                    <span class="tl-icon">
                        <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_botella.webp" alt="">
                    </span>
                    <div class="tl-text">
        ...
        <div class="dc-dress" data-aos="fade-up">
            ...
            <div class="dc-attire" aria-hidden="true">
                <span class="dc-attire-icon">
                    <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_varon.webp" alt="">
                </span>
                <span class="dc-attire-icon">
                    <img src="{$_layoutParams.root}views/danielayjean/imgs/icono_dama.webp" alt="">
                </span>
            </div>
