...
<div class="gift-container" id="gifts">
  <div class="gift-section" data-aos="fade-up">
    ...
    <svg class="gift-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 87.8 95.11" aria-hidden="true">
      <g id="b">
        <g id="c">
          <path
    ...
    <p class="gift-intro">
      Su amor y compañía son nuestro mayor regalo.<br>
      Cualquier detalle adicional será<br>
      recibido con cariño.
    </p>
    ...
    <p class="gift-account-holder">A nombre de Jesyka Brighitt Pinto Delgado</p>
