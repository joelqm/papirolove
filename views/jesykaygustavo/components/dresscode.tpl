...
<div class="dresscode-container" id="dresscode">
  ...
  <div class="dresscode-content">
    ...
    <div class="dresscode-left" data-aos="fade-up">
      ...
      <img src="{$_layoutParams.root}views/jesykaygustavo/imgs/pareja_muestra_dresscode.webp"
    ...
    <div class="dresscode-right" data-aos="fade-up">
      <img src="{$_layoutParams.root}views/jesykaygustavo/imgs/dresscode_pareja.webp" alt="Jesyka y Gustavo"
