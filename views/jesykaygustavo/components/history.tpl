...
<section class="history-section">
  ...
  <div class="audio-container-history" style="margin: 0px auto;">
    <audio id="myAudio" src="{$_layoutParams.root}views/jesykaygustavo/sound/song.mp3" preload="auto"></audio>
  </div>
  ...
  <div class="container-history" id="new-history">
    ...
    <div class="history-images" data-aos="fade-up">
      ...
      <div class="photo-stack">
        <img src="{$_layoutParams.root}views/jesykaygustavo/imgs/novios.webp" alt="Jesyka y Gustavo"
          class="novios-image">
      </div>
