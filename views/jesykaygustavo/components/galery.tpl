<style>
    ...
    .flower-top-left {
        ...
        width: 400px;
        height: 370px;
        background-image: url('{$_layoutParams.root}views/jesykaygustavo/imgs/flor-arriba-izq.png'); /* ¡Cambia esto por tu archivo real! */
    ...
    .flower-bottom-right {
        ...
        height: 350px;
        background-image: url('{$_layoutParams.root}views/jesykaygustavo/imgs/flor-abajo-der.png'); /* ¡Cambia esto por tu archivo real! */
        background-size: contain;
...
<section class="galery" id="galery">
    ...
    <div class="container-galery">
        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{$_layoutParams.root}views/jesykaygustavo/imgs/preboda-1.webp" alt="Imagen 1">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/jesykaygustavo/imgs/preboda-2.webp" alt="Imagen 2">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/jesykaygustavo/imgs/preboda-3.webp" alt="Imagen 3">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/jesykaygustavo/imgs/preboda-4.webp" alt="Imagen 3">
            </div>
        </div>
    </div>
</section>
