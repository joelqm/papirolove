<style>
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/jesykaygustavo/fonts/Baskervville-Regular.ttf");
        font-display: swap;
    }
    @font-face {
        font-family: 'CalliforniaSignature';
        src: url("{$_layoutParams.root}views/jesykaygustavo/fonts/CalliforniaSignature.ttf");
        font-display: swap;
    }

    @font-face {
        font-family: 'newyork_personal';
        src: url("{$_layoutParams.root}views/jesykaygustavo/fonts/newyork_personal_use.otf") format("opentype");
        font-display: swap;
    }
...
<div class="coming-soon-page">
    <div class="coming-soon-card">
        ...
        <img class="coming-soon-logo"
             src="{$_layoutParams.root}views/jesykaygustavo/imgs/logo.png"
             alt="Jesyka y Gustavo">

        <h1 class="coming-soon-names">Jesyka &amp; Gustavo</h1>
