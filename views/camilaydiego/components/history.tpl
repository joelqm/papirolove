  ...
  <div class="container-history" id="new-history">
    ...
    <div class="history-images" data-aos="fade-up">
      ...
      <div class="photo-stack">
        <img src="{$_layoutParams.root}views/camilaydiego/imgs/preboda-2.webp" alt="Foto de la pareja"
          class="circular-image">
        <img src="{$_layoutParams.root}views/camilaydiego/imgs/preboda-1.webp" alt="Pareja en las vías del tren"
