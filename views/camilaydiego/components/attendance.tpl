<div class="attendace-container" id="attendance" style="position: relative; overflow: hidden;">
    ...
    <div class="gift-section" data-aos="fade-up">
        ...
        <h3 class="date">30.09.26</h3>

        <a href="https://docs.google.com/forms/d/e/1FAIpQLSdvHdisG6v0bLwHmqW8sjKJWmm7HKNvLZ2uSeJMA3nWjg1eoA/viewform?usp=sharing&ouid=116663290609750251722" class="button-3" target="_blank" rel="noopener noreferrer">
            Confirma Aquí
        </a>
    ...
    <!-- <img class="attendance-decor"
         src="{$_layoutParams.root}views/camilaydiego/imgs/img_001.png"
         alt=""
         aria-hidden="true"> -->
