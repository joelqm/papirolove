...
<section id="section_form_mensaje" class="section-bg-color" style="display: none;">
    ...
    <div class="notification-bar">
        <div class="notification-content">
            ...
            registro y hacer llegar tu presente a Camila & Diego
        </div>
    </div>
    ...
    <div class="main-container">
        ...
        <div class="gift-card">
            <div class="card-header">
                <span class="font-titulo-obsequio">Camila & Diego</span>
            </div>
...
<script src="https://api.micuentaweb.pe/static/js/krypton-client/V4.0/stable/kr-payment-form.min.js"
    kr-public-key="{$pk}" kr-post-url-success="{$_layoutParams.root}camilaydiego/estado/{$codigo}">
    </script>
{block name="styles"}
<style>
    /* General Styles */
