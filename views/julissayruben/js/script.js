$(document).ready(function () {
  ...
  var targetDate = new Date("October 10, 2026 14:30:00").getTime();
...
function crearEventoEnGoogleCalendar() {
  ...
  */
  ...
  const url = `https://calendar.app.google/TqHweizMuLdMuJnx5`;
