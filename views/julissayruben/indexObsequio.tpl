...
<section id="section_form_mensaje" class="section-bg-color" style="display: none;">
    ...
    <div class="notification-bar">
        <div class="notification-content">
            ...
            registro y hacer llegar tu presente a Julissa y Rubén
        </div>
    </div>
    ...
    <div class="main-container">
        ...
        <div class="gift-card">
            <div class="card-header">
                <span class="font-titulo-obsequio">Julissa & Rubén</span>
            </div>
...
<script src="https://api.micuentaweb.pe/static/js/krypton-client/V4.0/stable/kr-payment-form.min.js"
    kr-public-key="{$pk}" kr-post-url-success="{$_layoutParams.root}julissayruben/estado/{$codigo}">
    </script>
{block name="styles"}
<style>
    /* General Styles */
    ...
    :root {
        --primary-color: #6D8397;
        /* Muted sage green */
        --primary-light: #8FA3B5;
        /* Lighter shade of primary */
        --primary-lighter: #A8B8C4;
        /* Even lighter shade */
        --primary-dark: #556879;
