...
<div class="container-page">
    ...
    <div class="header">
        <!--
        <h1 class="couple-name font-bellisia" data-aos="fade-up">Claudia y Angelo</h1>
        -->
        <img class="" src="{$_layoutParams.root}views/claudiayangelo/imgs/logo_02.webp" alt="logo" width="430">
        <p class="wedding-date" data-aos="fade-up">SÁBADO, 02 DE MAYO DEL 2026</p>

        <audio id="myAudio" src="{$_layoutParams.root}views/claudiayangelo/sound/song.mp3">
        </audio>
