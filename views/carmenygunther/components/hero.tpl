...
<div class="container-page">
    ...
    <div class="wedding-grid">
        ...
        <!-- Columna izquierda -->
        <!-- <div class="col-left">
            <img src="{$_layoutParams.root}views/carmenygunther/imgs/logo_02.webp" alt="logo" class="logo">
            <audio id="myAudio" src="{$_layoutParams.root}views/carmenygunther/sound/song.mp3"></audio>
        </div> -->
