<style>
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/carmenygunther/fonts/Baskervville-Regular.ttf");
        font-display: swap;
    }
    @font-face {
        font-family: 'CalliforniaSignature';
        src: url("{$_layoutParams.root}views/carmenygunther/fonts/CalliforniaSignature.ttf");
        font-display: swap;
    }

    @font-face {
        font-family: 'newyork_personal';
        src: url("{$_layoutParams.root}views/carmenygunther/fonts/newyork_personal_use.otf") format("opentype");
        font-display: swap;
    }
...
<div class="coming-soon-page">
    <div class="coming-soon-card">
        ...
        <img class="coming-soon-logo"
             src="{$_layoutParams.root}views/carmenygunther/imgs/logo.png"
             alt="Carmen y Gunther">

        <h1 class="coming-soon-names">Carmen &amp; Gunther</h1>
