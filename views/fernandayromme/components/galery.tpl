<section class="galery" id="galery">
    ...
    <div class="container-galery">
        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-1.webp" alt="Imagen 1">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-2.webp" alt="Imagen 2">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-3.webp" alt="Imagen 3">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-5.webp" alt="Imagen 3">
            </div>
            <div class="item"><img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-4.webp" alt="Imagen 3">
            </div>
        </div>
    </div>
</section>
