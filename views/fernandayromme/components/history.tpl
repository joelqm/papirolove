...
<section class="history-section">
    ...
    <audio id="myAudio" src="{$_layoutParams.root}views/fernandayromme/sound/song.mp3" preload="auto"></audio>
    ...
    <div class="container-history" id="new-history">
        ...
        <!-- <div class="rm-container">
            <img class="history-logo" src="{$_layoutParams.root}views/fernandayromme/imgs/logo.webp" alt="logo">
        </div> -->
        <div class="divider"></div>

        <div class="history-images" data-aos="fade-up">
            <img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-2.webp" alt="Foto de la pareja"
                class="circular-image">
            <img src="{$_layoutParams.root}views/fernandayromme/imgs/preboda-1.webp" alt="Pareja en las vías del tren"
