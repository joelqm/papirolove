<section id="section_form_mensaje" class="section-bg-color" style="display: none;">
    ...
    <div class="notification-bar">
        <div class="notification-content">
            <span class="heart-icon">♥</span> Deslízate hacia abajo y presiona el botón <strong>Obsequiar y enviar</strong> para completar el
...
<footer id="footer-onepage">
    <div class="footer-content">
        <p>¿Quieres tu propio espacio de Celebremos? Contáctanos al <a href="https://wa.me/51941034307">941034307</a></p>
    </div>
</footer>
...
<script src="https://api.micuentaweb.pe/static/js/krypton-client/V4.0/stable/kr-payment-form.min.js" 
        kr-public-key="{$pk}" 
        kr-post-url-success="{$_layoutParams.root}richiymili/estado/{$codigo}">
</script>
...
@media (max-width: 480px) {
    ...
    */
    ...
    .kr-embedded[kr-popin] div.kr-popin-modal-header .kr-popin-modal-header-image img.kr-header-logo {
        content: url("https://celebremos.pe/views/layout/neela/images/logo-white-2023.png");
