<div class="container-galery" id="galery">
    <div class="owl-carousel owl-theme">
        <div class="item"><img src="{$_layoutParams.root}views/shirleyycrysthian/imgs/preboda.webp" alt="Imagen 1"></div>
        <div class="item"><img src="{$_layoutParams.root}views/shirleyycrysthian/imgs/preboda-1.webp" alt="Imagen 2"></div>
        <div class="item"><img src="{$_layoutParams.root}views/shirleyycrysthian/imgs/preboda-2.webp" alt="Imagen 3"></div>
        <div class="item"><img src="{$_layoutParams.root}views/shirleyycrysthian/imgs/preboda-3.webp" alt="Imagen 4"></div>
    </div>
</div>
