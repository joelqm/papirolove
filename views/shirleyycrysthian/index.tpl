{block name="styles"}
    <link rel="stylesheet" type="text/css" href="{$_layoutParams.root}views/shirleyycrysthian/css/style.css">
{/block}
...
{include file="views/shirleyycrysthian/components/dresscode.tpl"}   
{include file="views/shirleyycrysthian/components/galery.tpl"}

<div class="pattern">
    {include file="views/shirleyycrysthian/components/attendance.tpl"}
