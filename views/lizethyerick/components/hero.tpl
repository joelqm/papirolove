...
<div class="container-page">
    ...
    <div class="header" style="justify-items: center;">
        <h1 class="couple-name" data-aos="fade-up">Lizeth <span style="margin-left: 1rem;">&</span>
            Erick</h1>
    ...
    <div class="wedding-grid">
        ...
        <!-- Columna izquierda -->
        <!-- <div class="col-left">
            <img src="{$_layoutParams.root}views/lizethyerick/imgs/logo_02.webp" alt="logo" class="logo">
            <audio id="myAudio" src="{$_layoutParams.root}views/lizethyerick/sound/song.mp3"></audio>
        </div> -->
