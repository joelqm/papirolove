{* Fuentes críticas Lizeth y Erick — font.php (MIME + CORS en producción) *}
<style>
@font-face {
...
<link rel="preload" href="{$_layoutParams.root}views/lizethyerick/imgs/backgroundprincipal.webp" as="image" fetchpriority="high" media="(min-width: 701px)">
<link rel="preload" href="{$_layoutParams.root}views/lizethyerick/imgs/preboda-2-original.webp" as="image" fetchpriority="high" media="(max-width: 700px)">
