...
data.cart = cartJson
        ...
        $.ajax({
            url: `${$("#root").val()}gabrielayeric_ceremonia/guardarMensajeMonto`, // Reemplaza con tu URL
            method: 'POST',
            data: data,
            success: function (response) {
                ...
                setTimeout(()=>{
                  window.location.href = `${$("#root").val()}gabrielayeric_ceremonia/obsequio/${formData[0].value}`
                },1000)
