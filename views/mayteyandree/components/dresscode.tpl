    ...
    <div class="dresscode-content" data-aos="fade-up">
        ...
        <div class="dc-left">
            ...
            <div class="dc-genders">
                <div class="dc-gender">
                    <img src="{$_layoutParams.root}views/mayteyandree/imgs/imagen_ellas.webp" alt="Ellas" class="dc-icon">
                    <p class="dc-gender-label">Ellas</p>
                    <p class="dc-gender-text">Vestido Largo</p>
                </div>
                <div class="dc-gender">
                    <img src="{$_layoutParams.root}views/mayteyandree/imgs/imagen_ellos.webp" alt="Ellos" class="dc-icon">
            ...
            <img src="{$_layoutParams.root}views/mayteyandree/imgs/paleta_colores.png"
        ...
        <div class="dc-right">
            ...
            <img src="{$_layoutParams.root}views/mayteyandree/imgs/dress_code.webp"
