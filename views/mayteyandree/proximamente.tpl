<style>
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/mayteyandree/fonts/Baskervville-Regular.ttf");
        font-display: swap;
    }
    @font-face {
        font-family: 'CalliforniaSignature';
        src: url("{$_layoutParams.root}views/mayteyandree/fonts/CalliforniaSignature.ttf");
        font-display: swap;
    }

    @font-face {
        font-family: 'newyork_personal';
        src: url("{$_layoutParams.root}views/mayteyandree/fonts/newyork_personal_use.otf") format("opentype");
        font-display: swap;
    }
...
<div class="coming-soon-page">
    <div class="coming-soon-card">
        ...
        <img class="coming-soon-logo"
             src="{$_layoutParams.root}views/mayteyandree/imgs/logo.png"
             alt="Mayte y Andree">

        <h1 class="coming-soon-names">Mayte &amp; Andree</h1>
