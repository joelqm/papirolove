<style>
    @font-face {
        ...
        src: url("{$_layoutParams.root}views/cynthiaykevin/fonts/Baskervville-Regular.ttf");
        font-display: swap;
    }
    @font-face {
        font-family: 'CalliforniaSignature';
        src: url("{$_layoutParams.root}views/cynthiaykevin/fonts/CalliforniaSignature.ttf");
        font-display: swap;
    }

    @font-face {
        font-family: 'newyork_personal';
        src: url("{$_layoutParams.root}views/cynthiaykevin/fonts/newyork_personal_use.otf") format("opentype");
        font-display: swap;
    }
...
<div class="coming-soon-page">
    <div class="coming-soon-card">
        ...
        <img class="coming-soon-logo"
             src="{$_layoutParams.root}views/cynthiaykevin/imgs/logo.png"
             alt="Cynthia y Kevin">

        <h1 class="coming-soon-names">Cynthia &amp; Kevin</h1>
