...
<div class="box box-body">
	<div class="row">
		<div class="col-md-12">
			...
			<form method="post">
				<input type="hidden" value="{$idrol}" id="idrole" />
				<div class="col-xs-12">
											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_vent_key ignorar" name="ing_vent_key" value="x"> </td> -->
													</tr>
												</tbody>
											</table>
										</div>
											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_gen_key ignorar" name="ing_repo_gen_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_key ignorar" name="ing_repo_key" value="x"> </td> -->
													</tr>
													<tr>
														<td>Reportes Porcentaje Meta</td>
													...
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_sto_pro_key ignorar" name="ing_repo_sto_pro_key" value="x"> </td> -->
													</tr>
													<tr>
														<td>Reportes Ticket Promedio</td>
													...
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_ven_pro_key ignorar" name="ing_repo_ven_pro_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_cos_fij_key ignorar" name="ing_repo_cos_fij_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_cos_var_key ignorar" name="ing_repo_cos_var_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_tot_env_key ignorar" name="ing_repo_tot_env_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_tot_ven_key ignorar" name="ing_repo_tot_ven_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_tot_uti_key ignorar" name="ing_repo_tot_uti_key" value="x"> </td> -->
													</tr>
													<tr>
														...
														<!-- <td><input type="radio" class="minimal ing_repo_caj_dia_key ignorar" name="ing_repo_caj_dia_key" value="x"> </td> -->
													</tr>
													<tr>
