$(document).on("ready",function() {
	...
	var habilitar = function(valor, idpermiso) {
		...
		$.post("/"+raizURL[1]+"/acl/habilitarUsuarios", "valor=" + valor + "&idpermiso=" + idpermiso + "&idusuario=" + $("#idusuario").val(), function(datos)
		{	
	...
	var denegar = function(valor, idpermiso) {
		$.post("/"+raizURL[1]+"/acl/denegarUsuarios", "valor=" + valor + "&idpermiso=" + idpermiso + "&idusuario=" + $("#idusuario").val(), function(datos)
		{	
			$("#msjDenegar").modal('show');
			setTimeout(function()
			{
				$("#msjDenegar").modal('hide').fadeOut(1500);
			},1500);
	...
	var ignorar = function(valor, idpermiso) {
		$.post("/"+raizURL[1]+"/acl/ignorarUsuarios", "valor=" + valor + "&idpermiso=" + idpermiso + "&idusuario=" + $("#idusuario").val(), function(datos)
		{
	...
	var mostrarPermisos = function(id) {
		...
		var _valorDen = "";
		var _valorIgn = "";
		$.post("/"+raizURL[1]+"/acl/verPermisosUsuario", "id=" + id, function(datos) {
	...
	{
		actualizar($("#e_idusuario").val(), $("#e_descripcion").val());
	});*/
